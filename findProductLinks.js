    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h2.product-name > a")
                    .map((i, e) => "https://bolanda-co.com" + $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = [
            "https://bolanda-co.com/%D9%85%D8%AD%D8%B5%D9%88%D9%84%D8%A7%D8%AA.html?limit=150",
        ];
