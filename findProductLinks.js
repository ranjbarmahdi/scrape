...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = [
            "https://abjetprinter.com/product-category/jetprinter/",
            "https://abjetprinter.com/product-category/egg-packing/",
            "https://abjetprinter.com/product-category/packing-machine/",
            "https://abjetprinter.com/product-category/accessories/",
            "https://abjetprinter.com/product-category/conveyor/",
        ];
    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h3.wd-entities-title > a")
                    .map((i, e) => $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://abjetprinter.com/"];
