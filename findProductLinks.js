    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h3.product-name > a")
                    .map((i, e) => 'https://www.kavianhamafza.com' + $(e).attr("href"))
                    .get();
                ...
                nextPageBtn = await page.$$(".page-link.next");
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://www.kavianhamafza.com/product/"];
