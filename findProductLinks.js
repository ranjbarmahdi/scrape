...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = [
            "https://www.asayeshco.com/%d8%af%d8%b3%d8%aa%da%af%d8%a7%d9%87-%d9%87%d8%a7/",
            "https://www.asayeshco.com/%d8%b3%d8%aa-%d8%ae%d8%b1%d8%b7%d9%88%d9%85%db%8c/",
            "https://www.asayeshco.com/%d9%be%d8%b1%db%8c%d8%b2%d9%87%d8%a7/",
            "https://www.asayeshco.com/%d9%84%d9%88%d9%84%d9%87-%d9%88-%d8%a7%d8%aa%d8%b5%d8%a7%d9%84%d8%a7%d8%aa/",
            "https://www.asayeshco.com/%d9%85%d8%ad%d8%b5%d9%88%d9%84%d8%a7%d8%aa-%d8%ae%d8%a7%d8%b5/",
        ];
    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h3.elementor-post__title > a")
                    .map((i, e) => $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://www.asayeshco.com/"];
