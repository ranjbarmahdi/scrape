...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = [
            "https://mahak.ir/product-category/gardening-tools/",
            "https://mahak.ir/product-category/consumables-and-peripherals/",
            "https://mahak.ir/product-category/desktop-and-stand-tools/",
            "https://mahak.ir/product-category/rechargeable-tool/",
            "https://mahak.ir/product-category/electrical-tools/",
        ];
    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h2.elementor-heading-title.elementor-size-default > a")
                    .map((i, e) => $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://mahak.ir/"];
