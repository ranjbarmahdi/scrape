...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = [
            "https://gitalco.com/fa/products-all-fa/busduct/busduct-lv-fa.html",
            "https://gitalco.com/fa/products-all-fa/busduct/busduct-mv-fa.html",
            "https://gitalco.com/fa/products-all-fa/trunking-fa.html",
            "https://gitalco.com/fa/products-all-fa/partitions-fa.html",
            "https://gitalco.com/fa/products-all-fa/partitions-fa.html",
        ];
    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $("h3.catItemTitle > a")
                    .map((i, e) => 'https://gitalco.com' + $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://gitalco.com/fa"];
