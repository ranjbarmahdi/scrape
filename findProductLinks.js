...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = [
            "https://azarpolika.com/product-category/product/%d8%a7%d8%aa%d8%b5%d8%a7%d9%84%d8%a7%d8%aa/",
            "https://azarpolika.com/product-category/product/%d9%84%d9%88%d9%84%d9%87/",
        ];
...
async function main() {
    try {
        const INITIAL_PAGE_URL = ["https://azarpolika.com/"];
