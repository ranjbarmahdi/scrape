...
async function findAllMainLinks(page, initialUrl) {
    ...
    try {
        ...
        const mainLinks = $(
            "body > div:nth-child(3) > main > div > div > div.row.row-cols-1.row-cols-lg-4.g-4.mb-lg-5 > div > div > figure >  a"
        )
            .map((i, e) => "https://tikhandle.com" + $(e).attr("href"))
            .get();
    ...
    for (let i = 0; i < allPagesLinks.length; i++) {
        try {
            ...
            do {
                ...
                const productsUrls = $(
                    "body > div:nth-child(3) > main > div > div > div.row.row-cols-1.row-cols-lg-4.g-4.mb-lg-5 > div > a"
                )
                    .map((i, e) => "https://tikhandle.com" + $(e).attr("href"))
                    .get();
...
async function main() {
    try {
        const INITIAL_PAGE_URL = [
            "https://tikhandle.com/4/?lang=fa",
            "https://tikhandle.com/3/?lang=fa",
            "https://tikhandle.com/2/?lang=fa",
            "https://tikhandle.com/1/?lang=fa",
            "https://tikhandle.com/5/?lang=fa",
            "https://tikhandle.com/6/?lang=fa",
            "https://tikhandle.com/7/?lang=fa",
        ];
