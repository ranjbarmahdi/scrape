...
async function scrapSingleProduct(page, productURL, imagesDIR, documentsDir, rowNumber = 1) {
    try {
        ...
        data["title"] = $("h1.product_title").length
            ? `${$("h1.product_title").text().trim()} ${"برند رزین بتن برتر"}`
            : "";
        ...
        data["brand"] = $("notFound").text()?.trim() || "رزین بتن برتر";
        ...
        // descriptionString
        const descriptionString = $('div[itemprop="description"] > p')
        ...
        // Download Images
        const image_xpaths = ["/html/body/div[1]/div/section/div[1]/div/div[2]/div//img"];
