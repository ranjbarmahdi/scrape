...
async function scrapSingleProduct(page, productURL, imagesDIR, documentsDir, rowNumber = 1) {
    try {
        ...
        const data = {};
        data["title"] = $(".page-title").length
            ? `${$(".page-title").text().trim()} ${"برند بتن شیمی خاورمیانه"}`
            : "";
        ...
        data["brand"] = $("notFound").text()?.trim() || "بتن شیمی خاورمیانه";
        ...
        // descriptionString
        const descriptionString = $(".theme-content  > p")
        ...
        // Download Images
        const image_xpaths = ["/html/body/div[2]/div/div[1]/div/div/div[1]//img"];
